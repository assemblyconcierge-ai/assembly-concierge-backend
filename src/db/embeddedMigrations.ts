...
`,
  ...
  {
    filename: '007_add_missing_job_status_values.sql',
    sql: `
DO $$
BEGIN
  IF NOT EXISTS (
...
`,
  ...
  {
    filename: '019_add_job_customer_contact_snapshots.sql',
    sql: `
...
`,
  ...
  {
    filename: '020_add_email_events_and_contractor_airtable_id.sql',
    sql: `
...
`,
  ...
  {
    filename: '023_contractor_missing_document_submissions.sql',
    sql: `
